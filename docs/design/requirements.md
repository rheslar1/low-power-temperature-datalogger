...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for Low-Power Temperature Datalogger. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: Battery-powered outdoor datalogger that wakes on schedule, samples temperature, writes compact records, and sleeps aggressively. | Scenario tests and documentation review. |
