# Low-Power Temperature Datalogger Runtime Design
...
1. Build a runtime profile for `low-power-temperature-datalogger`.
...
The runtime must make this focus measurable through logs, reports, tests, diagrams, or hardware captures. The proof point for review is: Measured power reduction, long-duration testing, hardware tradeoff documentation, and practical battery-life engineering.
