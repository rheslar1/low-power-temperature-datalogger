# Low-Power Temperature Datalogger Deep Architecture
...
C++17, C++ Design Patterns, SOLID, Low power MCU, I2C sensor, RTC wake, Deep sleep, SD/Flash logging, Battery profiling
